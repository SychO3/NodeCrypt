...
const LANGUAGES = {
	en: {
		...
		translations: {
			...
			// Login and main UI
			'ui.enter_node': 'Start a new chat',
			...
			'help.what_is_nodecrypt': '🔐 What is SecureChat?',
			'help.what_is_nodecrypt_desc': 'SecureChat is a true zero-knowledge end-to-end encrypted chat system. With a database-free architecture, all messages are encrypted locally on your device, and the server serves only as an encrypted data relay station, unable to access any of your plaintext content.',
			...
			'help.decentralized_desc': 'The server is not involved in the encryption and decryption process',
	...
	zh: {
		...
		translations: {
			...
			'help.what_is_nodecrypt': '🔐 什么是 SecureChat？',
			'help.what_is_nodecrypt_desc': 'SecureChat 是一个真正的端到端加密聊天系统。采用无数据库架构，所有消息在您的设备上本地加密，服务器仅作为加密数据的中转站，无法获取您的任何明文内容。',
			'help.how_to_start': '🚀 快速开始',
			'help.step_username': '输入用户名',
			'help.step_username_desc': '选择一个在房间中显示的昵称，可以是任何您喜欢的名称',
			'help.step_node_name': '设置房间名称',
			...
			'help.decentralized_desc': '服务器不参与加密解密过程',
			'help.usage_tips': '💡 使用技巧',
			'help.important_note': '⚠️ 重要提示',
			'help.room_isolation_note': '相同房间名称但不同密码的是两个完全独立的房间，无法相互通信。',
			'help.tip_private_chat': '私人对话',
			'help.tip_private_chat_desc': '使用复杂的房间名称和密码，只分享给特定人员',
			'help.tip_group_chat': '群聊',
			'help.tip_group_chat_desc': '使用简单易记的房间名称和密码，方便多人加入',
			'help.tip_security_reminder': '安全提醒',
			'help.tip_security_reminder_desc': '房间名称和密码都需要完全一致才能进入同一个房间',
